...
// 🔥 ضفنا الـ import بتاع خدمة زيكو هنا (اتأكدي من المسار لو مختلف عندك)
import '../../../common/services/zego_call_service.dart';
    ...
    return BlocConsumer<AuthCubit, AuthState>(
      listener: (context, state) {
        if (state is AuthSuccess) {
          ...
          if (role == 'Patient') {
            // 🔥 تشغيل خدمة زيكو للمريض في الخلفية
            ZegoCallService.initZegoService(
              userID: "patient_menna", // مستقبلاً هتتغير للـ ID الحقيقي
              userName: "Menna (Patient)",
            );
            ...
            // 🔥 تشغيل خدمة زيكو للدكتور في الخلفية
            ZegoCallService.initZegoService(
              userID: "therapist_doaa", // مستقبلاً هتتغير للـ ID الحقيقي
              userName: "Doaa (Therapist)",
            );
